...
> Ronda marocaine — jeu de cartes traditionnel 2 a 4 joueurs.

[![Build APK](https://github.com/salistar/sally-ronda/actions/workflows/android-build.yml/badge.svg)](https://github.com/salistar/sally-ronda/actions/workflows/android-build.yml)
[![Lint & Test](https://github.com/salistar/sally-ronda/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/salistar/sally-ronda/actions/workflows/lint-and-test.yml)

App mobile faisant partie de la suite **SallyCards** — Expo SDK 52, React Native 0.76, Hermes, expo-router.

| | |
|---|---|
| **Bundle ID Android** | `com.sallycards.ronda` |
| **Bundle ID iOS** | `com.sallycards.ronda` |
| **Couleur thème** | `#DC2626` |
...
- Ronda classique 2-4 joueurs (1v1 ou 2v2 en equipe)
- Multi-joueur en ligne via Socket.IO + voice chat WebRTC (TURN)
- Bots IA avec 3 niveaux (facile / normal / dur)
- Annonces de chkobba (capture totale) + sietta
- Calcul automatique des points et des manches
- 5 langues + RTL Arabe (FR / EN / ES / AR / Darija)
...
```powershell
git clone https://github.com/salistar/sally-ronda.git
cd sally-ronda
npm install
npx expo start
...
subst Y: C:\Users\$env:USERNAME\Desktop\sally-ronda
cd Y:\
...
# Install + launch
adb uninstall com.sallycards.ronda 2>$null
adb install -r app\build\outputs\apk\debug\app-debug.apk
adb shell am start -n com.sallycards.ronda/.MainActivity
...
keytool -genkeypair -v -storetype PKCS12 `
  -keystore ronda.keystore -alias ronda `
  -keyalg RSA -keysize 2048 -validity 10000

# 2) Configurer android/gradle.properties
@"
RONDA_UPLOAD_STORE_FILE=ronda.keystore
RONDA_UPLOAD_KEY_ALIAS=ronda
RONDA_UPLOAD_STORE_PASSWORD=<password>
RONDA_UPLOAD_KEY_PASSWORD=<password>
