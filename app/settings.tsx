/**
 * @file settings.tsx
 * @description Settings modal for Ronda. Language + Theme now driven by
  ...
  return (
    <View style={[s.container, { backgroundColor: palette.bg }]}>
      ...
      <ScrollView contentContainerStyle={s.scrollContent}>
        ...
        <View style={s.footer}>
          <Text style={[s.footerText, { color: palette.textSecondary }]}>SallyCards · Ronda v1.0.0</Text>
