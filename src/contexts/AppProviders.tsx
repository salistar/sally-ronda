...
const DARK: Palette = {
  isDark: true,
  bg: '#0A0A1A',
  bgGradient: ['#0A0A1A', '#1F0A0A', '#2B1202'] as const,
  card: 'rgba(26, 22, 50, 0.85)',
  cardGradient: ['#1E1B3A', '#2A1F4D'] as const,
  text: '#F3F4F6',
  textSecondary: '#9CA3AF',
  accent: '#DC2626',
  accentGradient: ['#DC2626', '#EA580C'] as const,
  danger: '#EF4444',
  success: '#10B981',
  gold: '#F59E0B',
  border: 'rgba(255,255,255,0.08)',
  headerGradient: ['#1F0A0A', '#3F0A0A', '#4B1F02'] as const,
};
...
const K_THEME = '@ronda/theme-mode';
const K_LOCALE = '@ronda/locale';
