 ...
 *   est rompue par un "Ronda!" (contestation) ou quand tout le monde passe
 *   sans contester (alors le joueur suivant peut recommencer avec une nouvelle
 *   valeur — cela clôt la séquence précédente).
 * - N'importe quel autre joueur peut crier "Ronda!" pour contester
...
export type GamePhase =
  ...
  | 'challenging'  // Fenêtre de contestation "Ronda!"
...
export function gameReducer(state: GameState, action: GameAction): GameState {
  switch (action.type) {
    ...
    case 'PLAY_CARD': {
      ...
      // poser une carte (= renoncer à crier Ronda) OU appuyer sur Ronda.
      ...
      // Seule une contestation Ronda! ou un nouveau round peut rompre la
